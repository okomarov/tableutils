...
try
    b = nativeVarfun(fun,a,groupVars,dataVars,outputFormat,errHandler,renameVars,supplied);
...
%-------------------------------------------------------------------------------
function b = nativeVarfun(fun,a,groupVars,dataVars,outputFormat,errHandler,renameVars,supplied)
